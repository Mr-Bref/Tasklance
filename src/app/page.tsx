    ...
    <div className="w-full h-screen bg-no-repeat bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1552196563-55cd4e45efb3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw4fHx5b2dhfGVufDB8MHx8fDE3MTY5NjgwNTN8MA&ixlib=rb-4.0.3&q=80&w=1080')]">
      <header className="lg:px-16 px-4 flex flex-wrap items-center py-4 shadow-sm">
        <div className="flex-1 flex justify-between items-center mix-blend-screen">
          <Link href="/" className="text-4xl text-gray-400 font-extrabold">
            PZONE
          </Link>
        </div>
          ...
          <nav>
            {session ? (
              <ul className="md:flex items-center justify-between text-base text-gray-600 pt-4 md:pt-0">
                <li>
                  <Link className="md:p-4 py-3 px-0 block" href="/dashboard">
                    Dashboard
                  </Link>
                </li>
              </ul>
              ...
              <ul className="md:flex items-center justify-between text-base text-gray-600 pt-4 md:pt-0">
                <li>
                  <Link className="md:p-4 py-3 px-0 block" href="/login">
                    Login
                  </Link>
                </li>
                <li>
                  <a className="md:p-4 py-3 px-0 block" href="/register">
                    Register
                  </a>
                </li>
              </ul>
      ...
      <div className="w-[90%] mx-auto h-full flex items-center justify-between py-10">
        ...
        <div className="flex flex-col gap-2 items-center text-2xl text-white mt-6">
          <a
            href="javascript:;"
            className="w-9 h-9 rounded-full bg-black/40 hover:bg-black/80 flex justify-center items-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
          ...
          <a
            href="javascript:;"
            className="w-9 h-9 rounded-full bg-black/40 hover:bg-pink-800/80  flex justify-center items-center"
          >
            <svg
          ...
          <a
            href="javascript:;"
            className="w-9 h-9 rounded-full bg-black/40 hover:bg-sky-600/80  flex justify-center items-center"
          >
            <svg
          ...
          <a
            href="javascript:;"
            className="w-9 h-9 rounded-full bg-black/40 hover:bg-rose-600/80  flex justify-center items-center"
          >
            <svg
